...
export default class {
    constructor(target) {        
        ...
        this.loader = (this.type) ? document.querySelector(".spinner") : false
        this.callbacks = {}
        this.state = {
...
const actions = {
    ...
    removeSpinner() {
        ...
        setTimeout(() => { this.loader.classList.add('is-disabled') }, 600)
        // this.loader.classList.remove('is-active')
...
function setVideoType(el) {
    this.videoElement = el.childNodes[0]
    return (el.childNodes[0].nodeName == "VIDEO") ? "video" : "vimeo"
}
function setupIOS() {
